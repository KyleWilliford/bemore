...
`/search [term]` Performs a search for the input term across all databases. Case insensitive matching. For a match to be found, the database record must _contain_ at least the input term.
